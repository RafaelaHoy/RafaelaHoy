...
-- Inserción de farmacias del Círculo de Farmacéuticos de Rafaela
INSERT INTO public.pharmacies (name, address, phone, created_at, updated_at) VALUES
-- Farmacia ABOAL
('Farmacia ABOAL', 'Av. Aristóbulo del Valle 1171, Rafaela, Santa Fe, Argentina', '03492-156611', NOW(), NOW()),

-- Farmacia ABRATE  
('Farmacia ABRATE', 'Av. Luis Fanti 102 y Colón, Rafaela, Santa Fe, Argentina', '03492-422819', NOW(), NOW()),

-- Farmacia BERNINI
('Farmacia BERNINI', 'Av. Luis Fanti 1510, Rafaela, Santa Fe, Argentina', '03492-437333', NOW(), NOW()),

-- Farmacia BLATTER
('Farmacia BLATTER', 'Av. Santa Fe 1460, Rafaela, Santa Fe, Argentina', '03492-436269', NOW(), NOW()),

-- Farmacia BRUERA
('Farmacia BRUERA', 'Tucumán 130, Rafaela, Santa Fe, Argentina', '03492-422729', NOW(), NOW()),
...
SELECT 
    'Farmacias insertadas' as resultado,
